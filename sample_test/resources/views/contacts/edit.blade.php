									...
									<div class="flex flex-wrap -m-2">
										...
										<div class="p-2 w-full">
											<div class="relative">
												...
												<input @if ($contact->gender === 0)checked @endif type="radio" id="gender" name="gender" value="0">男性
												<input @if ($contact->gender === 1)checked @endif type="radio" id="gender" name="gender" value="1">女性
											</div>
										</div>
										<div class="p-2 w-full">
											<div class="relative">
												<select name="age">
													<option @if ($contact->age === null) selected @endif value="">選択してください</option>
													<option @if ($contact->age === 1) selected @endif value="1">〜19歳</option>
													<option @if ($contact->age === 2) selected @endif value="2">20歳〜29歳</option>
													<option @if ($contact->age === 3) selected @endif value="3">30歳〜39歳</option>
													<option @if ($contact->age === 4) selected @endif value="4">40歳〜49歳</option>
													<option @if ($contact->age === 5) selected @endif value="5">50歳〜59歳</option>
													<option @if ($contact->age === 6) selected @endif value="6">60歳〜</option>
												</select>
											</div>
										</div>
										<div class="p-2 w-full">
